...
<div class="row">
    <div class="col-10 row">
        ...
        foreach ($data["product_ed"] as $value) {
            ...
            echo "<a href='".URL."index.php/home/details/".$value["id"]."'><img class='proo card-img-top' style='width: 250px; height: 400px;' src='".URL."public/img/" . $value["image"] . "' alt='" . $value["image"] . "'></a>";
